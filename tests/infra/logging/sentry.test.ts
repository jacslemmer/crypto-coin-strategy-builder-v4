...
import {
  ...
  flushSentry,
  closeSentry,
} from '../../../src/infra/logging/sentry.js';
...
describe('Sentry Integration', () => {
  ...
  describe('Integration with logger', () => {
    it('should log Sentry initialization success', () => {
      ...
      // Ensure Sentry.init mock is working
      vi.mocked(Sentry.init).mockImplementation(() => {});
      
      // Reset mock logger only
