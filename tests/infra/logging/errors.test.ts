...
import {
  ...
  ErrorFactory,
  ErrorHandler,
} from '../../../src/infra/logging/errors.js';
...
describe('Error Classes', () => {
  ...
  describe('ApiError', () => {
    it('should create API error with status code', () => {
      ...
      expect(error.isOperational).toBe(true); // 4xx errors are operational
    ...
    it('should mark 5xx errors as system errors', () => {
      ...
      expect(error.isOperational).toBe(false); // 5xx errors are system errors
    });
  });
  ...
  describe('ConfigurationError', () => {
    it('should create configuration error with config key', () => {
      ...
      expect(error.isOperational).toBe(false); // Configuration errors are system errors
...
describe('ErrorFactory', () => {
  it('should create errors with job context', () => {
    const error = ErrorFactory.withJobContext(
      DatabaseError,
      'job-123',
      'Database failed',
      'INSERT',
...
describe('ErrorHandler', () => {
  ...
  describe('handleError', () => {
    it('should handle AppError instances', () => {
      ...
      // Mock the captureInSentry method
